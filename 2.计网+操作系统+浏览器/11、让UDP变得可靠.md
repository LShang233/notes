...
[![怎么让不可靠的UDP可靠？](https://raw.githubusercontent.com/LShang233/mdImg/master/img/20220301150129.png)](https://s3.amazonaws.com/infoq.content.live.0/articles/how-to-make-udp-reliable/zh/resources/2651-1515087518382.png)
...
[![怎么让不可靠的UDP可靠？](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9zdGF0aWMwMDEuaW5mb3EuY24vcmVzb3VyY2UvaW1hZ2UvM2EvYmQvM2E0YzllNzFlZDg1ZDBiNzk1ZjgxYzVmNDUxYTQ2YmQucG5n?x-oss-process=image/format,png)](https://s3.amazonaws.com/infoq.content.live.0/articles/how-to-make-udp-reliable/zh/resources/2002-1515087517872.png)
...
定时重传很好理解，就是发送端如果在发出数据包（T1）时刻一个 RTO 之后**还未收到**这个数据包的 ACK 消息，那么发送端就重传这个数据包。这种方式依赖于接收端的 ACK 和 RTO，容易产生误判，主要有两种情况：
...
请求重传就是接收端在发送 ACK 的时候**携带自己丢失报文的信息反馈**，发送端接收到 ACK 信息时根据丢包反馈进行报文重传。如下图：

[![怎么让不可靠的UDP可靠？](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9zdGF0aWMwMDEuaW5mb3EuY24vcmVzb3VyY2UvaW1hZ2UvZGMvZTcvZGM5NzczOGY4ZjRhYzRhYzU2NDdlMDZjN2YxYzJiZTcucG5n?x-oss-process=image/format,png)](https://s3.amazonaws.com/infoq.content.live.0/articles/how-to-make-udp-reliable/zh/resources/1703-1515087518061.png)
...
除了定时重传和请求重传模式以外，还有一种方式就是以 FEC 分组方式选择重传，FEC（Forward Error Correction）是一种**前向纠错**技术，一般通过 XOR 类似的算法来实现，也有多层的 EC 算法和 raptor 涌泉码技术，其实是一个解方程的过程。应用到 RUDP 上示意图如下：

[![怎么让不可靠的UDP可靠？](https://imgconvert.csdnimg.cn/aHR0cHM6Ly9zdGF0aWMwMDEuaW5mb3EuY24vcmVzb3VyY2UvaW1hZ2UvOWQvNGEvOWQ2ZjNhMmY4YzI3Y2I1MDExYWZhNWM1ZTczOGE0NGEucG5n?x-oss-process=image/format,png)](https://s3.amazonaws.com/infoq.content.live.0/articles/how-to-make-udp-reliable/zh/resources/1364-1515087518179.png)
...
FEC 分组方式适合解决要求**延时敏感且随机丢包**的传输场景，在一个带宽不是很充裕的传输条件下，FEC 会增加多余的包，可能会使得网络更加不好。FEC 方式不仅可以配合请求重传模式，也可以配合定时重传模式。

## RTT 与 RTO 的计算

在上面介绍重传模式时多次提到 RTT、RTO 等时间度量，RTT（Round Trip Time）即网络环路延时，环路延迟是通过发送的数据包和接收到的 ACK 包计算的，示意图如下：

[![怎么让不可靠的UDP可靠？](https://imgconvert.csdnimg.cn/aHR0cHM6Ly